  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px] relative'>
      <IoMdArrowRoundBack className="absolute top-[30px] left-[30px] text-white cursor-pointer w-[25px] h-[25px]" onClick={()=>navigate("/")} />
        <h1 className='text-white mb-[40px] text-[30px] text-center'>Select your <span className='text-blue-400'>Assistant Image</span></h1>
        ...
        <div className='w-[90%] max-w-[60%] flex justify-center items-center flex-wrap gap-[15px]'>
           ...
           <Card  image={image6}/>
           <Card  image={image7}/>
            <div className={`w-[70px] h-[170px] lg:w-[150px] lg:h-[250px] bg-[#030326] border-2 border-[##0000ff66] rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-blue-950 cursor-pointer hover:border-4 hover:border-white flex justify-center items-center ${selectedImage=="input"?"border-4 border-white shadow-2xl shadow-blue-950 ":null}`} onClick={()=>{
